  ...
  <div class="contact-page">
    ...
    <form @submit.prevent="handleSubmit" class="contact-form">
      ...
      <div>
        ...
        <textarea id="message" v-model="form.message" rows="2" required></textarea>
      </div>
...
export default {
  ...
  data() {
    return {
      address: '79 rue Raoul Briquet, 62710 Courrières, France',
      telephone : '03 21 37 09 90',
      form: {
        name: '',
        email: '',
        message: '',
